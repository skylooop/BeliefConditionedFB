...
register(
    ...
    entry_point='envs.new_minigrid.genie:GenieEnv10x10'
)

register(
    id='MiniGrid-Genie-8x8-v0',
    entry_point='envs.new_minigrid.genie:GenieEnv8x8'
)

register(
    id='MiniGrid-NoisyTV-Genie-8x8-v0',
    entry_point='envs.new_minigrid.genie:NoisyTVGenieEnv8x8'
)

register(
    id='MiniGrid-Lying-Genie-8x8-v0',
    entry_point='envs.new_minigrid.genie:LyingGenieEnv8x8'
)

register(
    id='MiniGrid-Genie-6x6-v0',
    entry_point='envs.new_minigrid.genie:GenieEnv6x6'
)